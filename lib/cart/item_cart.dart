...
class ItemCart extends StatefulWidget {
  ...
  final ValueChanged<double> f5;
  final ValueChanged<bool> shiree;
  ItemCart({Key key, this.productCart, this.f5, this.shiree}) : super(key: key);
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        setState(() {
                          ...
                          widget.f5(widget.productCart.productPrice);
                        });
                      },
                    ),
                        ...
                        onPressed: () {
                          setState(
                            () {
                              ...
                              widget.shiree(widget.productCart.remove);
                            },
                          );
                        })
                  ],
